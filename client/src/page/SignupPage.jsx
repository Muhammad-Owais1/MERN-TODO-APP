...
export default function SignupPage() {
    ...
    return (
        <div className='uppercase flex flex-col justify-center items-center gap-10'>
            <h1 className='text-center pt-28 pb-10 font-["Montserrat"] font-semibold text-4xl '>signup</h1>
            ...
            <div className='flex justify-center items-center gap-2 '>
                ...
                <button onClick={handleSubmit} className='border-black border-2 h-10 w-[80px] rounded-3xl font-["Montserrat"] hover:bg-black'>Submit</button>
            </div>
        </div>
    )
}
